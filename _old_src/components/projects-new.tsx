  ...
  return (
    ...
    >
      <div
        ...
        className="holographic-card bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 h-full"
        style={{
          '--mouse-x': '50%',
          '--mouse-y': '50%',
